...
describe('useTerminalRendererSession', () => {
  ...
  it('should provide expected API surface', () => {
    const { result } = renderHook(() => useTerminalRendererSession({ leafId: 'leaf-1' }))
  ...
  it('should push dormant data for buffering', () => {
    const { result } = renderHook(() => useTerminalRendererSession({ leafId: 'leaf-2' }))
  ...
  it('should flush dormant data through write callback', () => {
    const { result } = renderHook(() => useTerminalRendererSession({ leafId: 'leaf-3' }))

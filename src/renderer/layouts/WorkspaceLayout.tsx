...
export default function WorkspaceLayout(): React.JSX.Element {
  ...
  const _activeTerminalId = useActiveTerminalId()
  ...
  }, [activeProject?.path, activeProjectId, activeProject])
  ...
  const _addCommand = useAddCommand()
  ...
  const _handleNewTerminal = useCallback(() => {

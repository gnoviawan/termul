...
!((t, e) => {
  ...
  function Wb(r, t, e) {
    function Gm(t) {
      return 1 === t ? 1 : i * 2 ** (-10 * t) * Q((t - a) * n) + 1
    }
    var i = 1 <= t ? t : 1,
      n = (e || (r ? 0.3 : 0.45)) / (t < 1 ? t : 1),
      a = (n / G) * (Math.asin(1 / i) || 0),
      s = 'out' === r ? Gm : 'in' === r ? (t) => 1 - Gm(1 - t) : Vb(Gm)
    return (n = G / n), (s.config = (t, e) => Wb(r, t, e)), s
  }
  function Xb(e, r) {
    function Om(t) {
    ...
    void 0 === r && (r = 1.70158)
    var t = 'out' === e ? Om : 'in' === e ? (t) => 1 - Om(1 - t) : Vb(Om)
    return (t.config = (t) => Xb(e, t)), t
  }
  var F,
    I,
    l,
          ...
          ? K(t)
            ? (function _flatten(t, e, i) {
                return (
                  void 0 === i && (i = []),
                  t.forEach((t) =>
                    (r(t) && !e) || cb(t, 1) ? i.push.apply(i, Pt(t)) : i.push(t)
                  ) || i
                )
              })(t, i)
            : cb(t)
      ...
      (g = {
        ...
        wake: function wake() {
          o &&
            ...
            p && g.sleep(),
            (_ = m || ((t) => setTimeout(t, (z - 1e3 * g.time + 1) | 0))),
            (d = 1),
            zl(2))
        },
    ...
    return t < N
      ...
      : t < 0.7272727272727273
        ...
        : t < 0.9090909090909092
          ...
          : B * (t - 2.625 / 2.75) ** 2 + 0.984375
  }
  ja('Linear,Quad,Cubic,Quart,Quint,Strong', (t, e) => {
    var r = e < 5 ? e + 1 : e
    Ub(
      t + ',Power' + (r - 1),
      e ? (t) => t ** r : (t) => t,
    ...
    (B = 7.5625),
    (N = 1 / 2.75),
    Ub('Bounce', (t) => 1 - dn(1 - t), dn),
    Ub('Expo', (t) => 2 ** (10 * (t - 1)) * t + t * t * t * t * t * t * (1 - t)),
    Ub('Circ', (t) => -($(1 - t * t) - 1)),
    Ub('Sine', (t) => (1 === t ? 1 : 1 - H(t * Z))),
      ...
      ht.SteppedEase =
        {
          config: function config(t, e) {
            ...
            var r = 1 / t,
              i = t + (e ? 0 : 1),
              n = e ? 1 : 0
            return (t) => (((i * Mt(0, 0.99999999, t)) | 0) + n) * r
          }
        }),
    (j.ease = Bt['quad.out']),
    ja(
    ...
    return (
      ...
      (e.add = function add(e, i) {
        if ((t(i) || (i = Ot(this, i, e)), !(e instanceof qt))) {
          if (K(e)) return e.forEach((t) => this.add(t, i)), this
      ...
      (e.totalDuration = function totalDuration(t) {
        ...
        if (arguments.length)
          return this.timeScale(
            (this._repeat < 0 ? this.duration() : this.totalDuration()) / (this.reversed() ? -t : t)
          )
        if (this._dirty) {
          for (i = this.parent; s; )
            (e = s._prev),
              ...
              o < (r = s._start) && this._sort && s._ts && !this._lock
                ? ((this._lock = 1), (Na(this, s, r - s._delay, 1)._lock = 0))
                : (o = r),
              r < 0 &&
                s._ts &&
                ((n -= r),
                ((!i && !this._dp) || (i && i.smoothChildTiming)) &&
                  ((this._start += la(r / this._ts)), (this._time -= r), (this._tTime -= r)),
                this.shiftChildren(-r, !1, -Infinity),
                (o = 0)),
              s._end > n && s._ts && (n = s._end),
              (s = e)
          Ua(this, this === L && this._time > n ? this._time : n, 1, 1), (this._dirty = 0)
        }
        return this._tDur
      }),
  ...
  var Zt,
    ...
    Kt = {}
  ja(Jt + ',id,stagger,delay,duration,paused,scrollTrigger', (t) => (Kt[t] = 1))
  var te = ((E) => {
      ...
      if (
        ...
        if (
          ...
          var A,
            ...
            z,
            R = 0
          if (K(k)) k.forEach((t) => s.to(P, t, '>')), s.duration()
          else {
            for (l in ((u = {}), k)) 'ease' === l || 'easeEach' === l || ic(l, k[l], u, k.easeEach)
            for (l in u)
              for (A = u[l].sort((t, e) => t.t - e.t), o = R = 0; o < A.length; o++)
  ...
  ta(te.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 }),
    ja('staggerTo,staggerFrom,staggerFromTo', (r) => {
      te[r] = function () {
        var t = new Gt(),
  ...
  var Ee = {
      ...
      return (
        ...
        i
          ? t
            ...
            : (t, e, r) => s(((mt[t] && mt[t].get) || a)(i, t, e, r))
          : i
      )
    },
    quickSetter: function quickSetter(r, e, i) {
      if (1 < (r = Pt(r)).length) {
        var n = r.map((t) => Fe.quickSetter(t, e, i)),
          a = n.length
        return (t) => {
          for (var e = a; e--; ) n[e](t)
        }
    ...
    registerEffect: function registerEffect(t) {
      ...
      ;(e || '')
        .split(',')
        .forEach((t) => t && !mt[t] && !ht[t] && T(i + ' effect requires ' + t + ' plugin.')),
        (gt[i] = (t, e, r) => n(Pt(t), ta(e || {}, a), r)),
        r &&
    ...
    utils: {
      wrap: function wrap(e, t, r) {
        var i = t - e
        return K(e) ? ob(e, wrap(0, e.length), t) : Za(r, (t) => ((i + ((t - e) % i)) % i) + e)
      },
      wrapYoyo: function wrapYoyo(e, t, r) {
        ...
        return K(e)
          ...
          : Za(r, (t) => e + (i < (t = (n + ((t - e) % n)) % n || 0) ? n - t : t))
      },
      distribute: hb,
      random: kb,
      snap: jb,
      ...
      unitize: function unitize(e, r) {
        return (t) => e(parseFloat(t)) + (r || _a(t))
      },
  ...
  ja('to,from,fromTo,delayedCall,set,killTweensOf', (t) => (Ee[t] = te[t])),
  ...
  function Md(t, e) {
    ...
    if (t in ur && n) {
      if (((this.tfm = this.tfm || {}), 'transform' === t))
        return _r.transform.split(',').forEach((t) => Md.call(this, t, e))
      if (
        (~(t = _r[t] || t).indexOf(',')
          ? t.split(',').forEach((t) => (this.tfm[t] = wr(i, t)))
  ...
  function Pd(t, e) {
    ...
    return (
      ...
      e && t.style && t.nodeType && e.split(',').forEach((t) => r.save(t)),
      r
    )
  }
  function Rd(t, e) {
  ...
  ja('padding,margin,Width,Radius', (e, r) => {
    var t = 'Right',
      i = 'Bottom',
      n = 'Left',
    ...
    kr[1 < r ? 'border' + e : e] = function (e, t, r, i, n) {
      ...
      if (arguments.length < 4)
        return (
          (a = o.map((t) => wr(e, t, r))), 5 === (s = a.join(' ')).split(a[0]).length ? a[0] : s
        )
      ;(a = (i + '').split(' ')),
        (s = {}),
  ...
  ;(Fe.utils.checkPrefix = yr),
    ...
    ja('x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective', (t) => {
      Y.units[t] = 'px'
    }),

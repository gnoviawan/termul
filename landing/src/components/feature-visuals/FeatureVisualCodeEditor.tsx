    ...
    <FeatureVisualFrameRoot>
      <FeatureVisualFrameWindow size="md" className="flex min-h-[180px] flex-col overflow-hidden">
        ...
        <div className="flex flex-1 min-h-[150px]">
          <div className="flex-1 bg-[#0d0d0d] p-3 font-mono text-[10px] flex flex-col gap-0.5 border-r border-white/5">
            <div>
          ...
          <div className="flex-1 bg-[#0a0a0a] p-3 text-[10px] flex flex-col gap-2">

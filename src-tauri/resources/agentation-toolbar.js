...
`;let N=$u(w),V=Np(N,{includeLeftRight:o==="detailed"||o==="forensic"});for(let G of V)l+=`   - ${G}
...
`,b){let E=$u($,m("original")),f=$u(C,m("current")),g=y?{width:$.width,height:$.height}:void 0;l+=`  - Currently ${i2(E,{x:$.x,y:$.y},g)}
...
.styles-module__switchContainer___Ka-AB:has(.styles-module__switchInput___kYDSD:checked) .styles-module__switchThumb___4sCPH {
  transform: translateX(8px);
}`,Z2={switchContainer:"styles-module__switchContainer___Ka-AB",switchInput:"styles-module__switchInput___kYDSD",switchThumb:"styles-module__switchThumb___4sCPH"};if(typeof document<"u"){let e=document.getElementById("feedback-tool-styles-switch-styles");e||(e=document.createElement("style"),e.id="feedback-tool-styles-switch-styles",document.head.appendChild(e)),e.textContent=q2}var bu=Z2,ku=({className:e="",...t})=>(0,Bi.jsxs)("div",{className:`${bu.switchContainer} ${e}`,children:[(0,Bi.jsx)("input",{className:bu.switchInput,type:"checkbox",...t}),(0,Bi.jsx)("div",{className:bu.switchThumb})]}),J2=`.styles-module__checkboxContainer___joqZk {
  display: flex;
  justify-content: center;
  align-items: center;
  position: relative;

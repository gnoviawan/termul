...
`,b){let E=Nu($,m("original")),f=Nu(C,m("current")),g=y?{width:$.width,height:$.height}:void 0;l+=`  - Currently ${l2(E,{x:$.x,y:$.y},g)}
...
`)}),r.trim()}var Q2=`@keyframes styles-module__markerIn___x4G8D {
  0% {
    opacity: 0;
...
.styles-module__switchContainer___Ka-AB:has(.styles-module__switchInput___kYDSD:checked) .styles-module__switchThumb___4sCPH {
  transform: translateX(8px);
}`,q2={switchContainer:"styles-module__switchContainer___Ka-AB",switchInput:"styles-module__switchInput___kYDSD",switchThumb:"styles-module__switchThumb___4sCPH"};if(typeof document<"u"){let e=document.getElementById("feedback-tool-styles-switch-styles");e||(e=document.createElement("style"),e.id="feedback-tool-styles-switch-styles",document.head.appendChild(e)),e.textContent=G2}var wu=q2,bu=({className:e="",...t})=>(0,Bi.jsxs)("div",{className:`${wu.switchContainer} ${e}`,children:[(0,Bi.jsx)("input",{className:wu.switchInput,type:"checkbox",...t}),(0,Bi.jsx)("div",{className:wu.switchThumb})]}),Z2=`.styles-module__checkboxContainer___joqZk {
  display: flex;
  justify-content: center;
  align-items: center;
  position: relative;
...
`;function Hp(){let e=window.__TERMUL_AGENTATION_ENDPOINT__,t=window.__TERMUL_AGENTATION_SESSION_ID__;if(e||console.warn("[Agentation] No endpoint configured \u2014 toolbar will not sync annotations"),document.getElementById("termul-agentation-host")?.shadowRoot)return;let o=document.createElement("div");o.id="termul-agentation-host",o.style.cssText="all: initial; position: fixed; z-index: 2147483647; bottom: 0; left: 0; right: 0; pointer-events: none;",document.body.appendChild(o);let r=o.attachShadow({mode:"open"}),l=document.createElement("style");l.textContent=ax,r.appendChild(l);let i=document.createElement("div");i.style.cssText="all: initial; pointer-events: auto;",r.appendChild(i);let s=(0,jp.createRoot)(i);s.render(Fp.default.createElement(zp,{endpoint:e||"http://127.0.0.1:0",sessionId:t,onAnnotationAdd:()=>{o.classList.add("agentation-toolbar-active")}})),window.__TERMUL_AGENTATION_ROOT__=s,window.__TERMUL_AGENTATION_HOST__=o,console.log("[Agentation] Toolbar mounted",{endpoint:e,sessionId:t})}function cx(){if(window.__REACT_DEVTOOLS_GLOBAL_HOOK__)return!0;let e=document.getElementById("root");return!!(e&&e._reactRootContainer||e&&Object.keys(e).some(t=>t.startsWith("__reactFiber"))||window.__NEXT_DATA__||window.___gatsby)}function Wp(){Hp()}function dx(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Wp):Wp()}function Up(){let e=window.__TERMUL_AGENTATION_ROOT__,t=window.__TERMUL_AGENTATION_HOST__;e&&e.unmount(),t?.parentNode&&t.parentNode.removeChild(t)}dx();window.addEventListener("beforeunload",Up);window.TermulAgentation={mount:Hp,unmount:Up,isReactPage:cx};})();
